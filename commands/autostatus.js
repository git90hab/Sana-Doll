...
const configPath = path.join(__SANA, '..', 'data', 'autoread.json');
...
function isBotMentionedInMessage(message, botNumber) {
    ...
    if (textContent) {
        ...
        const botNames = [global.botname?.toLowerCase(), 'bot', 'SANA-TECH', 'SANA-TECH bot'];
